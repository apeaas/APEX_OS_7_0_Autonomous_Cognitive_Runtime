...
fs.writeFileSync(path.join(dest,"BACKUP_INFO.json"),JSON.stringify({createdAt:new Date().toISOString(),source:root,version:"7.0.0",executionMode:"PAPER_ONLY"},null,2));
console.log(dest);
